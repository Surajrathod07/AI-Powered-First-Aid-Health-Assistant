...
const RadiologyView: React.FC<RadiologyViewProps> = ({ onNavigate, onSetSharedData }) => {
  ...
  const handlePatientDetailChange = (field: keyof PatientDetails, value: string | number) => {
  ...
  const handleShare = () => {
      ...
      const summary = `My Health Summary:\nPatient: ${patientDetails.name || 'Me'}\nIssue: ${report.clinicalSummary.substring(0, 100)}...\n\nThis report was generated by MedScan AI.`;
        ...
        <div className="lg:col-span-2">
          {report ? (
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-500 border-2 border-dashed border-slate-800 rounded-3xl min-h-[400px]">
              ...
              <p className="text-sm">Fill in the details and click "Generate Medical Report"</p>
            </div>
          )}
        </div>
      </div>
